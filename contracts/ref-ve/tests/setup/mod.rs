...
pub use ref_ve::{ContractContract as VeContract,
    Metadata, Proposal, ProposalKind, IncentiveType, Action, Account, FarmingReward, Config
};

pub use ref_ve::{
    DAY_SEC, DAY_TS, DEFAULT_MIN_PROPOSAL_VOTING_PERIOD_SEC, DEFAULT_MAX_PROPOSAL_VOTING_PERIOD_SEC,
    DEFAULT_MIN_PROPOSAL_START_VOTE_OFFSET, DEFAULT_MAX_LOCKING_DURATION_SEC, DEFAULT_MAX_LOCKING_REWARD_RATIO,
    DEFAULT_LOCK_NEAR_AMOUNT_FOR_PROPOSAL, DEFAULT_MIN_PER_LOCK_LPT_AMOUNT
};

pub use ref_ve::{
    E002_NOT_ALLOWED, 
    E100_ACC_NOT_REGISTERED, E101_INSUFFICIENT_BALANCE, 
    E200_ALREADY_VOTED, E201_INVALID_VOTE, E204_VOTE_CAN_NOT_CANCEL, E205_NOT_VOTABLE, E206_NO_VOTED,
    E301_INVALID_RATIO, E302_INVALID_DURATION, E305_STILL_IN_LOCK, 
    E401_NOT_ENOUGH_LOCK_NEAR, E402_INVALID_START_TIME, E403_INVALID_VOTING_PERIOD, E404_PROPOSAL_NOT_EXIST, E405_PROPOSAL_NOT_SUPPORT_INCENTIVE, E406_EXPIRED_PROPOSAL,
    E700_NOT_NEED_STORAGE
};
...
near_sdk_sim::lazy_static_include::lazy_static_include_bytes! {
    PREV_REF_VE_WASM_BYTES => "../../res/ref_ve.wasm",
