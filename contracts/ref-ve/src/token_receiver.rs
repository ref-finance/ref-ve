...
impl FungibleTokenReceiver for Contract {
    fn ft_on_transfer(
        ...
        match message {
            FTokenReceiverMessage::Reward { proposal_id, incentive_key } => {

                let (total_amount, start_at) = self.internal_deposit_reward(proposal_id, incentive_key, &token_id, amount);
